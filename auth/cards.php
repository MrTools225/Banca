            ...
            <div id="header-nav" class="collapse navbar-collapse">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="dropdown"> <a class="dropdown-toggle" href="#">Features<i class="arrow"></i></a>
                  <ul class="dropdown-menu" style="display: none; height: 8.82791px; padding-top: 0.356131px; margin-top: 0px; padding-bottom: 0.356131px; margin-bottom: 0px;">
                ...
                <li class="dropdown dropdown-mega"> <a class="dropdown-toggle" href="#">Pages<i class="arrow"></i></a>
                  <ul class="dropdown-menu" style="margin-left: -688.969px; display: none; height: 0.0752495px; padding-top: 0.0049344px; margin-top: 0px; padding-bottom: 0.0049344px; margin-bottom: 0px;">
                    <li>
      ...
      <div class="row"> 
        ...
        <div class="col-lg-9">
          ...
          <div class="bg-light shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 font-weight-400 mb-4">Mes cartes bancaires <span class="text-muted text-4"></span></h3>
            <div class="row">
              <div class="col-12 col-sm-6 col-lg-4">
                <div class="account-card account-card-primary text-white rounded p-3 mb-4 mb-lg-0">
                  ...
                  <p class="d-flex align-items-center"> <span class="account-card-expire text-uppercase d-inline-block opacity-6 mr-2">Expir<br>
                  ...
                  <p class="d-flex align-items-center m-0"> <span class="text-uppercase font-weight-500"><?php echo $nom; ?></span> <img class="ml-auto" src="images/payment/visa.png" alt="visa" title=""> </p>
              ...
              <div class="col-12 col-sm-6 col-lg-4">
                <div class="account-card text-white rounded p-3 mb-4 mb-lg-0">
                  ...
                  <p class="d-flex align-items-center m-0"> <span class="text-uppercase font-weight-500"><?php echo $nom; ?></span> <img class="ml-auto" src="images/payment/mastercard.png" alt="mastercard" title=""> </p>
                  <div class="account-card-overlay rounded"> <a href="#" data-target="#edit-card-details" data-toggle="modal" class="text-light btn-link mx-2"><span class="mr-1"><i class="fas fa-edit"></i></span>Edit</a> <a href="#" class="text-light btn-link mx-2"><span class="mr-1"><i class="fas fa-minus-circle"></i></span>Delete</a> </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-4"> <a href="" data-target="#add-new-card-details" data-toggle="modal" class="account-card-new d-flex align-items-center rounded h-100 p-3 mb-4 mb-lg-0">
                <p class="w-100 text-center line-height-4 m-0"> <span class="text-3"><i class="fas fa-plus-circle"></i></span> <span class="d-block text-body text-3">Commander une nouvelle carte</span> </p>
                </a> </div>
            </div>
          </div>
                ...
                <div class="modal-body p-4">
                  <form id="updateCard" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" data-bv-field="editcardHolderName" id="editcardHolderName" required="" value="<?php echo $nom; ?>" placeholder="Card Holder Name">
                    </div>
                    ...
                    <div class="col-sm-7">
                      ...
                      <div class="px-3">
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li class="text-muted"><?php echo $nom; ?></li>
                        </ul>
                        <ul class="list-unstyled">
                ...
                <div class="modal-body p-4">
                  <form id="addbankaccount" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" data-bv-field="accountName" id="accountName" required="" value="" placeholder="e.g. <?php echo $nom; ?>">
                    </div>
                    <div class="form-group">
